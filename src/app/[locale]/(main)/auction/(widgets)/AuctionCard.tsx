...
const AuctionCard = ({ car }: { car: IShopVehicle }) => {
	...
	return (
		<div className='w-[270px] relative bg-white rounded-xl'>
			<CardPhotos
				boxCl='max-xl:!w-auto max-xl:!min-h-[170px]'
				photos={photos}
				setPhotos={setPhotos}
				loop={false}
					...
					<p className='font-semibold text-lg'>
						{car.price.prev ? (
							<div className='relative'>
								<span>{priceFormatter.format(Number(car.price.prev))}</span>
							</div>
						) : car.price.last ? (
							<div className='relative'>
