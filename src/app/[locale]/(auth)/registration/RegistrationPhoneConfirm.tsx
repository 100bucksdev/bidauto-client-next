		...
		>
			<div>
				<div className='flex justify-center text-xl font-semibold mb-4'>
					{`${t('auth.verificationCode')} +${userInReg.phone_number.slice(
						0,
						-4
					)}XXXX. ${t('auth.confirmPhone')}`}
				</div>
				<form
...
RegistrationPhoneConfirm.displayName = 'RegistrationPhoneConfirm'
