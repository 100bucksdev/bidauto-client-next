...
const HomeSearchBarArea = () => {
	...
	const lotsByVinOrId = useGetLot({ params: { vinOrId: search } })

	return (
		<section className='w-full px-2 py-2 rounded-2xl h-auto max-sm:h-auto max-lg:h-auto lg:h-auto bg-white'>
